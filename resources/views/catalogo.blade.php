		...
		<div class="container">
			...
			<div class="row isotope-grid">
				@foreach ($productos as $producto)
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal{{ $producto->id }}">
									Vista Rápida
								</a>
							</div>
					...
					<!-- Modal{{ $producto->id }} -->
					<div class="wrap-modal1 js-modal{{ $producto->id }} p-t-60 p-b-20">
						<div class="overlay-modal1 js-hide-modal{{ $producto->id }}"></div>

						<div class="container">
							<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
								<button class="how-pos3 hov3 trans-04 js-hide-modal{{ $producto->id }}">
